 ...
 var dzSparkLine = function(){
					...
					datasets: [
						{
							...
							borderColor: 'rgba(83, 185, 234, 0.2) 1)',
							borderWidth: "0",
							backgroundColor: 'rgba(83, 185, 234, 0.2) 1)'
						}
					]
				},
				options: {
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(0, "rgba(83, 185, 234, 0.2) 1)");
			barChart_2gradientStroke.addColorStop(1, "rgba(83, 185, 234, 0.5)");
	...
	var barChart3 = function(){
		...
		if(jQuery('#barChart_3').length > 0 ){
			...
			barChart_3gradientStroke.addColorStop(0, "rgba(83, 185, 234, 0.2) 1)");
			barChart_3gradientStroke.addColorStop(1, "rgba(83, 185, 234, 0.5)");
					...
					datasets: [
						{
							...
							pointBackgroundColor: 'rgba(83, 185, 234, 0.2) 1)'
						}
					]
				},
				options: {
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(0, "rgba(83, 185, 234, 0.2) 1)");
			lineChart_2gradientStroke.addColorStop(1, "rgba(83, 185, 234, 0.5)");
					...
					datasets: [
						{
							...
							borderWidth: "2",
							backgroundColor: 'transparent', 
							pointBackgroundColor: 'rgba(83, 185, 234, 0.5)'
						}
					]
				},
				options: {
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(0, "rgba(83, 185, 234, 0.2) 1)");
			lineChart_3gradientStroke1.addColorStop(1, "rgba(83, 185, 234, 0.5)");
					...
					datasets: [
						{
							...
							borderWidth: "1",
							backgroundColor: 'rgba(83, 185, 234, 0.2) .5)', 
			...
			new Chart(pie_chart, {
				...
				data: {
					...
					datasets: [{
						...
						borderWidth: 0, 
						backgroundColor: [
							"rgba(83, 185, 234, 0.2) .9)",
							"rgba(83, 185, 234, 0.2) .7)",
							"rgba(83, 185, 234, 0.2) .5)",
							"rgba(0,0,0,0.07)"
						],
			...
			new Chart(doughnut_chart, {
				...
				data: {
					...
					datasets: [{
						...
						backgroundColor: [
							"rgba(83, 185, 234, 0.2) 1)",
							"rgba(100, 24, 195, 1)",
							"rgba(255, 62, 62, 1)"
						],
						hoverBackgroundColor: [
							"rgba(83, 185, 234, 0.2) 0.9)",
							"rgba(100, 24, 195, .9)",
							"rgba(255, 62, 62, .9)"
						]
